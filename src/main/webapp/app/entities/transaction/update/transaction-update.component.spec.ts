...
describe('Transaction Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('should call Compte query and add missing value', () => {
      ...
      const compteSource: ICompte = { id: 21096 };
      transaction.compteSource = compteSource;
      const compteDestination: ICompte = { id: 21096 };
      ...
      const additionalComptes = [compteSource, compteDestination];
    ...
    it('should update editForm', () => {
      ...
      expect(comp.comptesSharedCollection).toContainEqual(compteSource);
      expect(comp.comptesSharedCollection).toContainEqual(compteDestination);
