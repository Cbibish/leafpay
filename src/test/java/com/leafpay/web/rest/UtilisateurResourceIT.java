...
class UtilisateurResourceIT {
    ...
    private static final String DEFAULT_TYPE_JUSTIFICATIF_AGE = "AAAAAAAAAA";
    private static final String UPDATED_TYPE_JUSTIFICATIF_AGE = "BBBBBBBBBB";
    ...
    public static Utilisateur createEntity() {
        return new Utilisateur()
            ...
            .typeJustificatifAge(DEFAULT_TYPE_JUSTIFICATIF_AGE)
    ...
    public static Utilisateur createUpdatedEntity() {
        return new Utilisateur()
            ...
            .typeJustificatifAge(UPDATED_TYPE_JUSTIFICATIF_AGE)
    ...
    void getAllUtilisateurs() throws Exception {
        ...
        restUtilisateurMockMvc
            ...
            .andExpect(jsonPath("$.[*].typeJustificatifAge").value(hasItem(DEFAULT_TYPE_JUSTIFICATIF_AGE)))
    ...
    void getUtilisateur() throws Exception {
        ...
        restUtilisateurMockMvc
            ...
            .andExpect(jsonPath("$.typeJustificatifAge").value(DEFAULT_TYPE_JUSTIFICATIF_AGE))
